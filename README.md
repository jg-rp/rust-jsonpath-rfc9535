...
Without attempting to optimize the grammar, and with some error checking as yet unimplemented, the pest-based parser benchmarks at 156,909 ns/iter, vs 74,718 ns/iter for the hand-crafted parser.
